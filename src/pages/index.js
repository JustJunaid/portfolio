    ...
    <div>
          ...
          <div className="container">
            ...
            <div className="row gap-y">
              <div className="col-md-6 col-lg-4">
                <Link
                  className="card card-body border hover-shadow-6 text-center py-6"
                  to="/ruby_card"
                >
                  <p>
                    <i className="icon-mobile lead-6 text-muted"></i>
                  </p>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <p>
                    <i className="icon-gears lead-6 text-muted"></i>
                  </p>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <p>
                    <i className="icon-tools lead-6 text-muted"></i>
                  </p>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <p>
                    <i className="icon-recycle lead-6 text-muted"></i>
                  </p>
                  <h5 className="card-title text-dark mb-0">
                    Shop From Online Merchants
                  </h5>
                  <p className="text-center text-muted">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  </p>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <p>
                    <i className="icon-browser lead-6 text-muted"></i>
                  </p>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <p>
                    <i className="icon-paintbrush lead-6 text-muted"></i>
                  </p>
                  <h5 className="card-title text-dark mb-0">
                    Repay At 0% Interest
                  </h5>
      ...
      <main className="main-content">
        <section className="section bg-gray" style={{ padding: "3rem 0" }}>
          <div className="container">
            <h3 style={{ marginBottom: "37px" }} className="text-center">
              <Link to="#">How The App Works</Link>
            </h3>
            <div className="row gap-y">
              <div className="col-lg-4">
                <div className="card card-body border text-center">
                  ...
                  <p>
                    <Link className="small-3 fw-600" to="/read_more">
                      Read more{" "}
              ...
              <div className="col-lg-4">
                <div className="card card-body border text-center">
                  <p className="my-5">
                    <i className="icon-chat lead-8 text-lighter"></i>
                  </p>
                  <h5>Transfer Money From Zeta</h5>
                  <p>
                    <Link className="small-3 fw-600" to="#">
                      Read more{" "}
                      <i className="fa fa-angle-right small-5 pl-1"></i>
                    </Link>
                  </p>
              ...
              <div className="col-lg-4">
                <div className="card card-body border text-center">
                  <p className="my-5">
                    <i className="icon-mic lead-8 text-lighter"></i>
                  </p>
            ...
            <p className="text-center mt-7">
              <Link className="btn btn-danger btn-round" to="/how_it_works">
                Read more
              </Link>
            </p>
          </div>
          ...
          <div className="container-fluid">
            <div className="row gap-y align-items-center">
              ...
              <div className="col-md-4 mx-auto order-md-first">
                <h3>Credit Score</h3>
                <p>
                  Keep your company’s data where it belongs with extensive
                  security and administration features.
                </p>
                <Link to="/read_more">
                  Read More <i className="ti-angle-right fs-10 ml-1"></i>
                </Link>
              </div>
            </div>
          </div>
